...
<body class="bg-light">
	...
	<script>
		window.onload=()=>{
			document.getElementById("id").addEventListener('change',function(){/* change : 어떠한 이벤트가 바뀔떄를 의미한다  */
			...
			document.getElementById("nickName").addEventListener('change',function(){/* change : 어떠한 이벤트가 바뀔떄를 의미한다  */
